...
(library Library_1
	...
	(patternDef "BLLP412S" (originalName "BLLP412S")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 6.350, -1.722) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.27 -6.7) (pt 13.97 -6.7) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 13.97 -6.7) (pt 13.97 -1.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 13.97 -1.2) (pt -1.27 -1.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.27 -1.2) (pt -1.27 -6.7) (width 0.025))
		)
	...
	(compDef "BLLP412S" (originalName "BLLP412S") (compHeader (numPins 12) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.fischerelektronik.de/web_fischer/en_GB/VA/BLLP412S/datasheet.xhtml")
		(attr "<Component Height>" "5")
		(attr "<STEP Filename>" "BLLP412S.stp")
		(attr "<STEP Offsets>" "X=6.35;Y=-1.2;Z=2.6")
